 ...
 * @generated
 */
public class LevelDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LevelDescriptionEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EditormodelParserProvider.getParser(EditormodelElementTypes.Level_3002, getParserElement(),
					EditormodelVisualIDRegistry
							.getType(editormodel.diagram.edit.parts.LevelDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}

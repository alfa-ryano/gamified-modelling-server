...
import editormodel.diagram.edit.commands.EditormodelCreateShortcutDecorationsCommand;
import editormodel.diagram.edit.policies.GameCanonicalEditPolicy;
import editormodel.diagram.edit.policies.GameItemSemanticEditPolicy;
...
public class GameEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "Editormodel"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command
							.chain(new ICommandProxy(new EditormodelCreateShortcutDecorationsCommand(getEditingDomain(),

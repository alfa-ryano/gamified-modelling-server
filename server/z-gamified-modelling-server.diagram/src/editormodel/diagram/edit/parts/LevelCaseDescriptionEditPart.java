 ...
 * @generated
 */
public class LevelCaseDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LevelCaseDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = EditormodelParserProvider.getParser(EditormodelElementTypes.LevelCase_3004, getParserElement(),
					EditormodelVisualIDRegistry
							.getType(editormodel.diagram.edit.parts.LevelCaseDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}

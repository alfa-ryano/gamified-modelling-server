...
import editormodel.diagram.edit.policies.EditormodelTextSelectionEditPolicy;
 ...
 * @generated
 */
public class DraggableItemDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DraggableItemDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new EditormodelTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return EditormodelElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = EditormodelParserProvider.getParser(EditormodelElementTypes.DraggableItem_3005, getParserElement(),
					EditormodelVisualIDRegistry
							.getType(editormodel.diagram.edit.parts.DraggableItemDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(
					new TextDirectEditManager(this, null, EditormodelEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}

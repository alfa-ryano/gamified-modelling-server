 ...
 * @generated
 */
public class SubStoryDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SubStoryDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = EditormodelParserProvider.getParser(EditormodelElementTypes.SubStory_3001, getParserElement(),
					EditormodelVisualIDRegistry
							.getType(editormodel.diagram.edit.parts.SubStoryDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}

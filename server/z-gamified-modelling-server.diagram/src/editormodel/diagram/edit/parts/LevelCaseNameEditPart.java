 ...
 * @generated
 */
public class LevelCaseNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LevelCaseNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EditormodelParserProvider.getParser(EditormodelElementTypes.LevelCase_3004, getParserElement(),
					EditormodelVisualIDRegistry
							.getType(editormodel.diagram.edit.parts.LevelCaseNameEditPart.VISUAL_ID));
		}
		return parser;
	}

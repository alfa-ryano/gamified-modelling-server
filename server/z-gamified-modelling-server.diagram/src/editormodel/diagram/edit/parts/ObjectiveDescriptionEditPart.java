 ...
 * @generated
 */
public class ObjectiveDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ObjectiveDescriptionEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EditormodelParserProvider.getParser(EditormodelElementTypes.Objective_3003, getParserElement(),
					EditormodelVisualIDRegistry
							.getType(editormodel.diagram.edit.parts.ObjectiveDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}

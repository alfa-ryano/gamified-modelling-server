...
public class CollaborationmodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected CollaborationmodelSwitch<Adapter> modelSwitch =
		new CollaborationmodelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCollaborationModelling(CollaborationModel object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link collaborationmodel.CollaborationModel <em>Collaboration Modelling</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

...
public class EditormodelPackageImpl extends EPackageImpl implements EditormodelPackage {
	 ...
	 * @generated
	 */
	private EEnum draggablE_ITEM_TYPEEEnum = null;
	 ...
	 * @generated
	 */
	public EEnum getDRAGGABLE_ITEM_TYPE() {
		return draggablE_ITEM_TYPEEEnum;
	}
	...
	public void createPackageContents() {
		...
		// Create enums
		modeltypeEEnum = createEEnum(MODELTYPE);
		draggablE_ITEM_TYPEEEnum = createEEnum(DRAGGABLE_ITEM_TYPE);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDraggableItem_Type(), this.getDRAGGABLE_ITEM_TYPE(), "type", null, 0, 1, DraggableItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(modeltypeEEnum, editormodel.MODELTYPE.class, "MODELTYPE");
		addEEnumLiteral(modeltypeEEnum, editormodel.MODELTYPE.OBJECT);
		addEEnumLiteral(modeltypeEEnum, editormodel.MODELTYPE.COLLABORATION);

		initEEnum(draggablE_ITEM_TYPEEEnum, editormodel.DRAGGABLE_ITEM_TYPE.class, "DRAGGABLE_ITEM_TYPE");
		addEEnumLiteral(draggablE_ITEM_TYPEEEnum, editormodel.DRAGGABLE_ITEM_TYPE.OBJECT_DRAGGABLE_CASE_ITEM);
		addEEnumLiteral(draggablE_ITEM_TYPEEEnum, editormodel.DRAGGABLE_ITEM_TYPE.CLASS_DRAGGABLE_CASE_ITEM);
		addEEnumLiteral(draggablE_ITEM_TYPEEEnum, editormodel.DRAGGABLE_ITEM_TYPE.SLOT_DRAGGABLE_CASE_ITEM);
		addEEnumLiteral(draggablE_ITEM_TYPEEEnum, editormodel.DRAGGABLE_ITEM_TYPE.OPERATION_DRAGGABLE_CASE_ITEM);

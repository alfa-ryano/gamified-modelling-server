...
public class GraphmodellingPackageImpl extends EPackageImpl implements GraphmodellingPackage {
	 ...
	 * @generated
	 */
	public EAttribute getEntity_EntityClass() {
	 ...
	 * @generated
	 */
	public EAttribute getEntity_Category() {
	 ...
	 * @generated
	 */
	public EAttribute getEntity_AccessModifier() {
		return (EAttribute)entityEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 * @generated
	 */
	public EAttribute getEntity_Width() {
	 ...
	 * @generated
	 */
	public EAttribute getEntity_Height() {
	 ...
	 * @generated
	 */
	public EReference getNode_Operations() {
	...
	public void createPackageContents() {
		...
		createEAttribute(entityEClass, ENTITY__ENTITY_CLASS);
		createEAttribute(entityEClass, ENTITY__GROUP);
		createEAttribute(entityEClass, ENTITY__CATEGORY);
		createEAttribute(entityEClass, ENTITY__ACCESS_MODIFIER);
		createEAttribute(entityEClass, ENTITY__X);
		createEAttribute(entityEClass, ENTITY__Y);
		createEAttribute(entityEClass, ENTITY__WIDTH);
		createEAttribute(entityEClass, ENTITY__HEIGHT);
		...
		createEReference(nodeEClass, NODE__OPERATIONS);
	...
	public void initializePackageContents() {
		...
		graphEClass.getESuperTypes().add(this.getEntity());
		...
		initEAttribute(getEntity_Value(), ecorePackage.getEString(), "value", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEntity_EntityClass(), ecorePackage.getEString(), "entityClass", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntity_Group(), ecorePackage.getEString(), "group", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntity_Category(), ecorePackage.getEString(), "category", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntity_AccessModifier(), ecorePackage.getEString(), "accessModifier", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntity_X(), ecorePackage.getEIntegerObject(), "x", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntity_Y(), ecorePackage.getEIntegerObject(), "y", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntity_Width(), ecorePackage.getEIntegerObject(), "width", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntity_Height(), ecorePackage.getEIntegerObject(), "height", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getNode_ParentNode(), this.getNode(), null, "parentNode", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getNode_Operations(), this.getOperation(), null, "operations", null, 0, -1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

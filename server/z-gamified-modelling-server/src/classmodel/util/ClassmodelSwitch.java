...
public class ClassmodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ClassmodelPackage.MODELLING_TYPE: {
			...
			case ClassmodelPackage.CLASS_MODEL: {
				...
				if (result == null) result = caseGraph(classModel);
				if (result == null) result = caseEntity(classModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ClassmodelPackage.CLASS_ELEMENT: {
				...
				if (result == null) result = caseEntity(classElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ClassmodelPackage.RELATIONSHIP_ELEMENT: {
				...
				if (result == null) result = caseEdge(relationshipElement);
				if (result == null) result = caseEntity(relationshipElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}

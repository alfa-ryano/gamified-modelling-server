 ...
 * @generated
 */
public class ObjectmodellingSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ObjectmodellingPackage.MODELLING_TYPE: {
				ModellingType modellingType = (ModellingType)theEObject;
				T result = caseModellingType(modellingType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ObjectmodellingPackage.OBJECT_MODELLING: {
				ObjectModelling objectModelling = (ObjectModelling)theEObject;
				T result = caseObjectModelling(objectModelling);
				if (result == null) result = caseGraph(objectModelling);
				if (result == null) result = caseEntity(objectModelling);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ObjectmodellingPackage.OBJECT_ELEMENT: {
			...
			case ObjectmodellingPackage.LINK_ELEMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Object Modelling</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Object Modelling</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseObjectModelling(ObjectModelling object) {
		return null;
	}

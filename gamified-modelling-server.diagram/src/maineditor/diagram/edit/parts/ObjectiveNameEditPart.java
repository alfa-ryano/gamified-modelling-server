...
import maineditor.diagram.edit.policies.MaineditorTextSelectionEditPolicy;
...
public class ObjectiveNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new MaineditorTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return MaineditorElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MaineditorParserProvider.getParser(MaineditorElementTypes.Objective_3001, getParserElement(),
					MaineditorVisualIDRegistry.getType(maineditor.diagram.edit.parts.ObjectiveNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, MaineditorEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}

...
import maineditor.diagram.edit.policies.CaseItemSemanticEditPolicy;
...
public class CaseEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MaineditorVisualIDRegistry.getType(CaseNameEditPart.VISUAL_ID));
	}

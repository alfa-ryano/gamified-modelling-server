...
public class CaseNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MaineditorParserProvider.getParser(MaineditorElementTypes.Case_3002, getParserElement(),
					MaineditorVisualIDRegistry.getType(maineditor.diagram.edit.parts.CaseNameEditPart.VISUAL_ID));
		}
		return parser;
	}

...
import maineditor.diagram.edit.policies.ObjectiveItemSemanticEditPolicy;
...
public class ObjectiveEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MaineditorVisualIDRegistry.getType(ObjectiveNameEditPart.VISUAL_ID));
	}

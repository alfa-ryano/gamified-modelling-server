...
public class LevelNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MaineditorParserProvider.getParser(MaineditorElementTypes.Level_2001, getParserElement(),
					MaineditorVisualIDRegistry.getType(maineditor.diagram.edit.parts.LevelNameEditPart.VISUAL_ID));
		}
		return parser;
	}

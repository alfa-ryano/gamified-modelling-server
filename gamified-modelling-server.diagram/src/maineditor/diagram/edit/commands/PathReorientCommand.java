...
public class PathReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return MaineditorBaseItemSemanticEditPolicy.getLinkConstraints().canExistPath_4001(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Level container = (Level) getLink().eContainer();
		return MaineditorBaseItemSemanticEditPolicy.getLinkConstraints().canExistPath_4001(container, getLink(), source,
				getNewTarget());
	}

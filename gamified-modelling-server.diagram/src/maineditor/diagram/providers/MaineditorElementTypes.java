 ...
 * @generated
 */
public class MaineditorElementTypes {

	/**
	* @generated
	*/
	private MaineditorElementTypes() {
	}
	...
	*/
	private static DiagramElementTypeImages elementTypeImages = new DiagramElementTypeImages(
			MaineditorDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory());
	...
	*/
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Game_1000, MaineditorPackage.eINSTANCE.getGame());

			elements.put(Level_2001, MaineditorPackage.eINSTANCE.getLevel());

			elements.put(Objective_3001, MaineditorPackage.eINSTANCE.getObjective());

			elements.put(Case_3002, MaineditorPackage.eINSTANCE.getCase());

			elements.put(Path_4001, MaineditorPackage.eINSTANCE.getPath());
		}
	...
	public static final DiagramElementTypes TYPED_INSTANCE = new DiagramElementTypes(elementTypeImages) {
		...
		*/
		...
		public boolean isKnownElementType(IElementType elementType) {
			return maineditor.diagram.providers.MaineditorElementTypes.isKnownElementType(elementType);
		}
		...
		*/
		...
		public IElementType getElementTypeForVisualId(int visualID) {
			return maineditor.diagram.providers.MaineditorElementTypes.getElementType(visualID);
		}
		...
		*/
		...
		public ENamedElement getDefiningNamedElement(IAdaptable elementTypeAdapter) {
			return maineditor.diagram.providers.MaineditorElementTypes.getElement(elementTypeAdapter);
		}
	};

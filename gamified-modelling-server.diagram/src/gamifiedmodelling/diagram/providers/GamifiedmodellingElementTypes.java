...
public class GamifiedmodellingElementTypes {
	...
	* @generated
	*/
	public static final IElementType Case_3003 = getElementType("gamified-modelling-server.diagram.Case_3003"); //$NON-NLS-1$
	/**
	* @generated
	*/
	...
	*/
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Case_3003, GamifiedmodellingPackage.eINSTANCE.getCase());
	...
	*/
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(Case_3003);

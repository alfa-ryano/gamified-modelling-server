 ...
 * @generated
 */
public class GamifiedmodellingModelingAssistantProvider extends ModelingAssistantProvider {
	...
	*/
	protected EObject selectElement(EObject[] elements) {
		...
		dialog.setMessage(Messages.GamifiedmodellingModelingAssistantProviderMessage);
		dialog.setTitle(Messages.GamifiedmodellingModelingAssistantProviderTitle);

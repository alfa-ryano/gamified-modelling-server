	...
	*/
	private ToolEntry createCase1CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Case1CreationTool_title,
				Messages.Case1CreationTool_desc, Collections.singletonList(GamifiedmodellingElementTypes.Case_3003));
		entry.setId("createCase1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(GamifiedmodellingElementTypes.getImageDescriptor(GamifiedmodellingElementTypes.Case_3003));

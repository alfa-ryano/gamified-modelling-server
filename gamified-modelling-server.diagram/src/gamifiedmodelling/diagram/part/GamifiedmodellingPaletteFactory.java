 ...
 * @generated
 */
public class GamifiedmodellingPaletteFactory {
	...
	*/
	private ToolEntry createCase1CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Case1CreationTool_title,
				Messages.Case1CreationTool_desc, Collections.singletonList(GamifiedmodellingElementTypes.Case_3002));
		entry.setId("createCase1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(GamifiedmodellingElementTypes.getImageDescriptor(GamifiedmodellingElementTypes.Case_3002));
	...
	*/
	private ToolEntry createLevel2CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Level2CreationTool_title,
				Messages.Level2CreationTool_desc, Collections.singletonList(GamifiedmodellingElementTypes.Level_2001));
		entry.setId("createLevel2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(GamifiedmodellingElementTypes.getImageDescriptor(GamifiedmodellingElementTypes.Level_2001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createObjective3CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Objective3CreationTool_title,
				...
				Collections.singletonList(GamifiedmodellingElementTypes.Objective_3001));
		entry.setId("createObjective3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(
				GamifiedmodellingElementTypes.getImageDescriptor(GamifiedmodellingElementTypes.Objective_3001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createPath1CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(Messages.Path1CreationTool_title,
				Messages.Path1CreationTool_desc, Collections.singletonList(GamifiedmodellingElementTypes.Path_4001));
		entry.setId("createPath1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(GamifiedmodellingElementTypes.getImageDescriptor(GamifiedmodellingElementTypes.Path_4001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}

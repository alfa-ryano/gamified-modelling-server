...
public class GamifiedmodellingDiagramUpdater {
	...
	* @generated
	*/
	public static List<GamifiedmodellingNodeDescriptor> getLevelLevelLevelCaseCompartment_7002SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.emptyList();
		}
	...
	*/
	public static List<GamifiedmodellingLinkDescriptor> getContainedLinks(View view) {
		...
		case CaseEditPart.VISUAL_ID:
			return getCase_3003ContainedLinks(view);
	...
	*/
	public static List<GamifiedmodellingLinkDescriptor> getIncomingLinks(View view) {
		...
		case CaseEditPart.VISUAL_ID:
			return getCase_3003IncomingLinks(view);
		case PathEditPart.VISUAL_ID:
	...
	*/
	public static List<GamifiedmodellingLinkDescriptor> getOutgoingLinks(View view) {
		...
		case CaseEditPart.VISUAL_ID:
			return getCase_3003OutgoingLinks(view);
		case PathEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public static List<GamifiedmodellingLinkDescriptor> getCase_3003ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<GamifiedmodellingLinkDescriptor> getCase_3003IncomingLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<GamifiedmodellingLinkDescriptor> getCase_3003OutgoingLinks(View view) {
		return Collections.emptyList();
	}

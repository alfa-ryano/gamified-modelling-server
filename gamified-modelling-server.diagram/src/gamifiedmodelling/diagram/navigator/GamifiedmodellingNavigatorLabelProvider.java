...
public class GamifiedmodellingNavigatorLabelProvider extends LabelProvider
	...
	public Image getImage(View view) {
		...
		case CaseEditPart.VISUAL_ID:
			return getImage("Navigator?Node?http://gamefulgrowth.blogspot.co.uk/gamified-modelling/?Case", //$NON-NLS-1$
					GamifiedmodellingElementTypes.Case_3003);
	...
	* @generated
	*/
	private String getCase_3003Text(View view) {
		IParser parser = GamifiedmodellingParserProvider.getParser(GamifiedmodellingElementTypes.Case_3003,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			GamifiedmodellingDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5004); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}

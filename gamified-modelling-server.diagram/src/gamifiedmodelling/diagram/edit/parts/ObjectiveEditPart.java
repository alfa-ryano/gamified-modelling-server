...
import gamifiedmodelling.diagram.edit.policies.ObjectiveItemSemanticEditPolicy;
...
public class ObjectiveEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(GamifiedmodellingVisualIDRegistry.getType(ObjectiveNameEditPart.VISUAL_ID));
	}

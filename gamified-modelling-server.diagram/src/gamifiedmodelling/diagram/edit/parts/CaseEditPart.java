...
import gamifiedmodelling.diagram.edit.policies.CaseItemSemanticEditPolicy;
...
public class CaseEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(GamifiedmodellingVisualIDRegistry.getType(CaseNameEditPart.VISUAL_ID));
	}

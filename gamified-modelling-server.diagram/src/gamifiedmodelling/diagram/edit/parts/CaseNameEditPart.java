...
public class CaseNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GamifiedmodellingParserProvider.getParser(GamifiedmodellingElementTypes.Case_3003,
					getParserElement(), GamifiedmodellingVisualIDRegistry
							.getType(gamifiedmodelling.diagram.edit.parts.CaseNameEditPart.VISUAL_ID));
		}
		return parser;
	}

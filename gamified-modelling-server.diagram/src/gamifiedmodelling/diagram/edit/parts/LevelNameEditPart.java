...
public class LevelNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GamifiedmodellingParserProvider.getParser(GamifiedmodellingElementTypes.Level_2001,
					getParserElement(), GamifiedmodellingVisualIDRegistry
							.getType(gamifiedmodelling.diagram.edit.parts.LevelNameEditPart.VISUAL_ID));
		}
		return parser;
	}

...
import gamifiedmodelling.diagram.edit.policies.GamifiedmodellingTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ObjectiveNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new GamifiedmodellingTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return GamifiedmodellingElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GamifiedmodellingParserProvider.getParser(GamifiedmodellingElementTypes.Objective_3001,
					getParserElement(), GamifiedmodellingVisualIDRegistry
							.getType(gamifiedmodelling.diagram.edit.parts.ObjectiveNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					GamifiedmodellingEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}

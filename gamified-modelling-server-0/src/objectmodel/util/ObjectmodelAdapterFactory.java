...
public class ObjectmodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ObjectmodelSwitch<Adapter> modelSwitch =
		new ObjectmodelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseObject(objectmodel.Object object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link objectmodel.Object <em>Object</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link objectmodel.Link <em>Link</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

...
public class ObjectmodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ObjectmodelPackage.OBJECT: {
				objectmodel.Object object = (objectmodel.Object)theEObject;
				T result = caseObject(object);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ObjectmodelPackage.LINK: {
	 ...
	 * @generated
	 */
	public T caseObject(objectmodel.Object object) {
		return null;
	}

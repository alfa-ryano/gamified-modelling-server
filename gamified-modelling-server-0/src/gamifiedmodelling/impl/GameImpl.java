 ...
 * </p>
 * <ul>
 *   <li>{@link gamifiedmodelling.impl.GameImpl#getLevels <em>Levels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GameImpl extends EObjectImpl implements Game {
	...
	protected EClass eStaticClass() {
		return GamifiedmodellingPackage.Literals.GAME;
	}
	...
	public EList<Level> getLevels() {
		if (levels == null) {
			levels = new EObjectContainmentEList<Level>(Level.class, this, GamifiedmodellingPackage.GAME__LEVELS);
		}
		return levels;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GamifiedmodellingPackage.GAME__LEVELS:

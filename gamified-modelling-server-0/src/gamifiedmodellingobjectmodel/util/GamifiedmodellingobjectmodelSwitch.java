 ...
 * @generated
 */
public class GamifiedmodellingobjectmodelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public GamifiedmodellingobjectmodelSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GamifiedmodellingobjectmodelPackage.OBJECT_MODEL: {
				ObjectModel objectModel = (ObjectModel)theEObject;
				T result = caseObjectModel(objectModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GamifiedmodellingobjectmodelPackage.OBJECT: {
				gamifiedmodellingobjectmodel.Object object = (gamifiedmodellingobjectmodel.Object)theEObject;
...
} //GamifiedmodellingobjectmodelSwitch

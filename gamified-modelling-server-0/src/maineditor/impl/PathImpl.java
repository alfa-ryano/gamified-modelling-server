 ...
 * </p>
 * <ul>
 *   <li>{@link maineditor.impl.PathImpl#getPrevLevel <em>Prev Level</em>}</li>
 *   <li>{@link maineditor.impl.PathImpl#getNextLevel <em>Next Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PathImpl extends EObjectImpl implements Path {
	...
	protected EClass eStaticClass() {
		return MaineditorPackage.Literals.PATH;
	}
		...
		if (prevLevel != null && prevLevel.eIsProxy()) {
			...
			if (prevLevel != oldPrevLevel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MaineditorPackage.PATH__PREV_LEVEL, oldPrevLevel, prevLevel));
			}
		}
		return prevLevel;
	}
	...
	public void setPrevLevel(Level newPrevLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MaineditorPackage.PATH__PREV_LEVEL, oldPrevLevel, prevLevel));
	}
	...
	public Level getNextLevel() {
		if (nextLevel != null && nextLevel.eIsProxy()) {
			...
			if (nextLevel != oldNextLevel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MaineditorPackage.PATH__NEXT_LEVEL, oldNextLevel, nextLevel));
			}
		}
		return nextLevel;
	}
	...
	public void setNextLevel(Level newNextLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MaineditorPackage.PATH__NEXT_LEVEL, oldNextLevel, nextLevel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MaineditorPackage.PATH__PREV_LEVEL:
				if (resolve) return getPrevLevel();
				return basicGetPrevLevel();
			case MaineditorPackage.PATH__NEXT_LEVEL:

 ...
 * @generated
 */
public class MaineditorPackageImpl extends EPackageImpl implements MaineditorPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see maineditor.MaineditorPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private MaineditorPackageImpl() {
		super(eNS_URI, MaineditorFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link MaineditorPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static MaineditorPackage init() {
		if (isInited) return (MaineditorPackage)EPackage.Registry.INSTANCE.getEPackage(MaineditorPackage.eNS_URI);

		// Obtain or create and register package
		MaineditorPackageImpl theMaineditorPackage = (MaineditorPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MaineditorPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MaineditorPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theMaineditorPackage.createPackageContents();

		// Initialize created meta-data
		theMaineditorPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theMaineditorPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(MaineditorPackage.eNS_URI, theMaineditorPackage);
		return theMaineditorPackage;
	}
	 ...
	 * @generated
	 */
	public MaineditorFactory getMaineditorFactory() {
		return (MaineditorFactory)getEFactoryInstance();
	}

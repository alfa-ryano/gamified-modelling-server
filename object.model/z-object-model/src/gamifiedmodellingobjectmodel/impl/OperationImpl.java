...
public class OperationImpl extends EObjectImpl implements Operation {
	...
	protected EClass eStaticClass() {
		return GamifiedmodellingobjectmodelPackage.Literals.OPERATION;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamifiedmodellingobjectmodelPackage.OPERATION__TEXT, oldText, text));
	}
